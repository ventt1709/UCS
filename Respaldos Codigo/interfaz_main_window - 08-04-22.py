...
def funcion_decorador(funcion):
    def wrapper(*args, **kwargs):
        # cosas que hacer antes de la funcion
        # print(f"Hola, esta linea esta decorando la funcion {str(funcion)}")
        try:
            resultado = funcion(*args, **kwargs)
        # cosas que hacer despues de la funcion
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, ModulosElasticos):
        ...
        ModulosElasticos.resize(1516, 697)
        ...
        self.page_def_axial_SG.setGeometry(QtCore.QRect(0, 0, 200, 281))
        ...
        self.page_def_diam_SG.setGeometry(QtCore.QRect(0, 0, 200, 281))
        ...
        self.page_def_axial_PP.setGeometry(QtCore.QRect(0, 0, 200, 281))
        ...
        self.page_def_diam_PP.setGeometry(QtCore.QRect(0, 0, 200, 281))
        ...
        self.gridLayout_19.addLayout(self.verticalLayout_10, 0, 0, 2, 1)
        ...
        self.label_titulo_filtroDatos_3.setMaximumSize(QtCore.QSize(300, 16777215))
        ...
        spacerItem7 = QtWidgets.QSpacerItem(888, 58, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_29 = QtWidgets.QGridLayout(self.tab_4)
        ...
        self.gridLayout_28.addWidget(self.widget_2, 0, 1, 1, 1)
        self.widget_3 = QtWidgets.QWidget(self.tab_4)
        self.widget_3.setStyleSheet("\n"
                                    "background-color: rgb(255, 255, 255);")
        self.widget_3.setObjectName("widget_3")
        self.gridLayout_28.addWidget(self.widget_3, 0, 2, 1, 1)
        self.frame_4 = QtWidgets.QFrame(self.tab_4)
        self.frame_4.setMaximumSize(QtCore.QSize(161, 1000))
        ...
        self.gridLayout_25.addLayout(self.verticalLayout_15, 0, 0, 1, 1)
        self.gridLayout_28.addWidget(self.frame_4, 0, 0, 1, 1)
        ...
        self.lineEdit_diametro_muestra.setText("")
        ...
        self.lineEdit_pesoMuestra.setText("")
        ...
        self.lineEdit_Largo_muestra.setText("")
        ...
        self.gridLayout_19.addWidget(self.tabWidget, 1, 1, 1, 1)
    ...
    def retranslateUi(self, ModulosElasticos):
        ...
        self.label_28.setText(_translate("ModulosElasticos", "Eje X"))
    ...
    def agregar_def_finales_a_tabla(self):
            ...
            self.deformaciones_agregadas = (
                    ...
                    (self.def_PP_creada, 'Def Axial PP', 'Def Diametral PP', 'Palpadores', ' Corregida')
    ...
    def obtener_esf_peak(self):
        ...
        self.tiempo_ensayo = round( self.tabla_completa['Tiempo'][-1] / 3600, 3)
        self.tiempo_post_peak = self.tiempo_ensayo - self.tiempo_pre_peak

        self.lineEdit_CargMax.setText(str(self.carga_maxima))
        self.lineEdit_ResMax.setText(str(self.esfuerzo_maximo))
        self.lineEdit_ResMaxNorm.setText(str(self.esfuerzo_maximo_norm))

        self.lineEdit_Duracion_PrePeak.setText(str(self.tiempo_pre_peak))
        self.lineEdit_Duracion_PostPeak.setText(str(self.tiempo_post_peak))
        self.lineEdit_Duracion_Ensayo.setText(str(self.tiempo_ensayo))
